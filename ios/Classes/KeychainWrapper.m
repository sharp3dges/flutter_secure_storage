...
- (NSDictionary *)getAll {
    return [[NSDictionary alloc] initWithDictionary: _keychainData];
}
...
- (void)resetKeychainItem
{
    ...
    _keychainData[(__bridge id) kSecAttrLabel] = @"Item label";
    _keychainData[(__bridge id) kSecAttrDescription] = @"Item description";
    _keychainData[(__bridge id) kSecAttrAccount] = @"Account";
    _keychainData[(__bridge id) kSecAttrService] = @"Service";
    _keychainData[(__bridge id) kSecAttrComment] = @"Your comment here.";
    _keychainData[(__bridge id) kSecValueData] = @"password";
}
